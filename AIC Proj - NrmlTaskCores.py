...
y=df[['NrmlTaskCores','JobType']]
y_0 = y.where(y['JobType'] ==0)
y_Job0 = y_0['NrmlTaskCores']

y_1 = y.where(y['JobType'] ==1)
y_Job1 = y_1['NrmlTaskCores']

y_2 = y.where(y['JobType'] ==2)
y_Job2 = y_2['NrmlTaskCores']

y_3 = y.where(y['JobType'] ==3)
y_Job3 = y_3['NrmlTaskCores']
